...
var Icon$13 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 585" }, props),
        React.createElement("image", { width: "512", height: "585", href: "/images/ami/logo.png" })));
};
...
var Icon$X = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/ami-profile.png" })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/xami.png" })));
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#041315de", backgroundDisabled: "#182021", backgroundAlt: "#00834661", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#172d2f", input: "#041315de", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#060f10", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#e2ddec", borderColor: "#524B63", gradients: {
        bubblegum: "linear-gradient(139.73deg,#7a6c1c 0%,#d5be1a 100%)",
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/amigos_official"
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/amigosswap",
    },
];
var MENU_HEIGHT = 80;
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; var isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd; _a.xamiPriceUsd; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, xamiPriceUsd = _a.xamiPriceUsd, links = _a.links; _a.profile; var children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, xamiPriceUsd: xamiPriceUsd, pushNav: setIsPushed, links: links }),
